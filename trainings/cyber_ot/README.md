...
Dashboard section ID: `cyberOT`  
LMS training name: Cyber OT Training #ABI
...
Open `../../dashboard/index.html` and use the **Cyber OT** tab.
...
python process_cyberot.py
```

Place `CyberOT.xlsx` and a Datamart `*.xlsx` in `../input/` (or pass paths as arguments where supported).
