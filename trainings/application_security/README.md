...
Dashboard section ID: `appSec`  
LMS training name: Introduction to Application Security #ABI
...
Open `../../dashboard/index.html` and use the **Application Security** tab.

## CLI (Python)

This training is processed in the browser dashboard only (no separate CLI script in the legacy `trainings` repo).
